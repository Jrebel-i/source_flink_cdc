...
public class MySqlSnapshotSplitAssigner implements MySqlSplitAssigner {
    ...
    @Override
    public void open() {
        chunkSplitter = createChunkSplitter(sourceConfig, isTableIdCaseSensitive);//创建 ChunkSplitter用来划分切片
    ...
    public Optional<MySqlSplit> getNext() {
        if (!remainingSplits.isEmpty()) {
            ...
            if (nextTable != null) {
                ...
                Collection<MySqlSnapshotSplit> splits = chunkSplitter.generateSplits(nextTable);//通过 ChunkSplitter 生成切片，并存储到Iterator中

...
//在构建ExecutionJobVertex时会创建真正需要执行的Execution,而这个Execution就是需要提交到TaskManager的
            // create the execution job vertex and attach it to the graph
            ExecutionJobVertex ejv = //deploy时调用的就是Execution.deploy()方法
                    new ExecutionJobVertex(//构建ExecutionJobVertex
                            this,
                            jobVertex,
            ...
            ejv.connectToPredecessors(this.intermediateResults);//根据上游分发策略判断是POINTWISE还是ALL_TO_ALL

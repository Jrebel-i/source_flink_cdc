    ...
    public void start() throws Exception {
        ...
        if (enumerator == null) {
            ...
            try (TemporaryClassLoaderContext ignored =
                ...
                enumerator = source.createEnumerator(context);//调用MySqlSource.createEnumerator() 创建 MySqlSourceEnumerator
            } catch (Throwable t) {
        ...
        runInEventLoop(() -> enumerator.start(), "starting the SplitEnumerator.");//MySqlSourceEnumerator 并调用start方法，做一些初始化工作
    }

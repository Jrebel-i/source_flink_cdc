...
public class DefaultDispatcherResourceManagerComponentFactory
    ...
    public DispatcherResourceManagerComponent create(
        ...
        try {
            ...
            resourceManager =
                    resourceManagerFactory.createResourceManager(  //todo 创建resourceManager
                            configuration,
                            ResourceID.generate(),
                            rpcService,
            ...
            final HistoryServerArchivist historyServerArchivist = //todo 创建HistoryServer
            ...
            dispatcherRunner =
                    dispatcherRunnerFactory.createDispatcherRunner( //todo 创建dispatcher
            ...
            resourceManager.start(); //todo 启动resourceManager
